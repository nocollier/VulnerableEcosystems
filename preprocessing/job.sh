...
CASE="run06"
DATA_LOCATION=/ccs/home/nate/cli143/nate/clustering/run06/data
mkdir -p results
mkdir -p logfiles
mkdir -p profiles
...
MACHINE=andes
STANDARDIZE=/ccs/home/jbk/bin/standardize.${MACHINE}
RAND_SEEDS=/ccs/home/jbk/bin/rand_seeds.${MACHINE}
PRAND_SAMPLE=/ccs/home/jbk/bin/prand_sample_bj.${MACHINE}
PSAMPLE=/ccs/home/jbk/bin/psample_dataset_new2.${MACHINE}
SEED_BINARY=/ccs/home/jbk/bin/pcluster_Ndist_accel.${MACHINE}
CLUSTER_PROCS=16
CLUSTER_BINARY=/ccs/home/jbk/bin/pcluster_Ndist_accel.${MACHINE}
